      ...
      <footer className="flexCenter pb-24 pt-28 dark:bg-[#1E201E] text-white">
        <div className="max_padd_container flex w-full flex-col gap-14">
          <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
            ...
            <div className="flex flex-wrap gaP-8 sm:justify-between md:flex-1 text-black dark:text-white">
          ...
          <p className="text-center regular-14 text-gray-30">2024 Shoptopia | All rights reserved.</p>
        </div>
      </footer>
    </>
  );
